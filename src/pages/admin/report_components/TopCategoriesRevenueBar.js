...
const TopCategoriesRevenueBar = ({
  selectedDate,
  title = "Top 5 หมวดหมู่สินค้ายอดขายสูงสุด (บาท) วันนี้",
}) => {
    ...
    const load = async () => {
      ...
      try {
        ...
        const { data } = await axios.get(
          `${API_BASE}/api/admin/reports/top-categories-revenue`,
...
export default TopCategoriesRevenueBar;
