...
const YearlyCustomerSegmentationChart = ({ selectedYear }) => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `${API_BASE}/api/admin/reports/yearly-customer-segmentation`,
          {
        ...
        console.error("Error loading yearly segmentation:", err);
  ...
  return (
    <Card className="h-100 w-100">
      <Card.Body className="d-flex flex-column">
        <Card.Title as="h6">การแบ่งกลุ่มลูกค้า (รายปี)</Card.Title>
        <div
...
export default YearlyCustomerSegmentationChart;
