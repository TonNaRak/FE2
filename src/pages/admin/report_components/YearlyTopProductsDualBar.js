...
const YearlyTopProductsDualBar = ({ selectedYear }) => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const res = await axios.get(
          `${API_BASE}/api/admin/reports/yearly-top-products`,
          {
    ...
    <Card className="h-100">
      <Card.Body className="pb-2">
        <Card.Title className="mb-2">
          Top 5 สินค้าขายดีของปี (บาท / จำนวนชิ้น)
        </Card.Title>
...
export default YearlyTopProductsDualBar;
